...
// GetRedisVersion provides a mock function with given fields: podName, rFailover
func (_m *RedisFailoverCheck) GetRedisVersion(podName string, rFailover *v1.RedisFailover) (string, error) {
...
// GetStatefulSetVersion provides a mock function with given fields: rFailover
func (_m *RedisFailoverCheck) GetStatefulSetVersion(rFailover *v1.RedisFailover) (string, error) {
	ret := _m.Called(rFailover)
